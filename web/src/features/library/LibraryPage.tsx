              ...
              {selectedCollection === null ? (
                <div className="flex flex-col items-center pt-16 text-white/30">
                  <div className="w-16 h-16 mb-4 rounded-xl bg-white/5 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="-5.0 -10.0 110.0 135.0" fill="currentColor" className="mt-2 opacity-80" height="46" width="46">
                      <path d="m89.465 60.02h-26.199c0.23828-0.44141 0.38672-0.9375 0.38672-1.4766 0-1.7266-1.3984-3.125-3.125-3.125h-0.50391v-4.2422h11.766c5.2266 0 9.4844-4.2539 9.4844-9.4805l-0.003907-27.141c0-5.2266-4.2539-9.4805-9.4844-9.4805h-43.578c-5.2266 0-9.4844 4.2539-9.4844 9.4805v27.141c0 5.2266 4.2539 9.4805 9.4844 9.4805h11.766v4.2422h-0.50391c-1.7266 0-3.125 1.3984-3.125 3.125 0 0.53906 0.14844 1.0352 0.38672 1.4766l-26.195-0.003906c-4.0859 0-7.4102 3.3242-7.4102 7.4102v24.375c0 1.7266 1.3984 3.125 3.125 3.125s3.125-1.3984 3.125-3.125v-14.477h81.25v14.477c0 1.7266 1.3984 3.125 3.125 3.125s3.125-1.3984 3.125-3.125v-24.375c0-4.0859-3.3242-7.4102-7.4102-7.4102zm-61.254-48.699h43.578c1.7812 0 3.2344 1.4492 3.2344 3.2305v19.898l-50.043 0.003906v-19.898c0-1.7812 1.4492-3.2305 3.2344-3.2305zm-3.2305 30.375v-0.99219h50.039v0.99219c0 1.7812-1.4492 3.2305-3.2344 3.2305h-43.578c-1.7812 0-3.2344-1.4492-3.2344-3.2305zm21.246 9.4844h7.5469v4.2422h-7.5469zm-36.852 19.895v-3.6445c0-0.64063 0.51953-1.1602 1.1602-1.1602h78.93c0.64062 0 1.1602 0.51953 1.1602 1.1602v3.6445z" />
                    </svg>
                  </div>
                ...
                <div className="max-w-4xl mx-auto">
                  {isLoading ? (
                    ...
                    <div className="text-center pt-16">
                      ...
                      <h3 className="text-lg font-medium text-white/30">No papers in this collection yet</h3>
