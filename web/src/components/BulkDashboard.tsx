      ...
      <div className="border-b border-white/5 px-8 py-6 flex justify-between items-center bg-surface/30 backdrop-blur-md">
        ...
        <div className="flex bg-white/5 p-1 rounded-xl border border-white/5">
          <button
            ...
            className={`px-6 py-2 text-sm font-semibold rounded-lg transition-all ${activeTab === 'pca'
          ...
          <div className="h-full bg-surface/30 backdrop-blur-md rounded-2xl border border-white/10 p-10 flex flex-col items-center justify-center text-center">
            {activeTab === 'pca' && (
              <>
                ...
                <h3 className="text-xl font-bold text-white mb-2 tracking-tight">Principal Component Analysis</h3>
            ...
            {activeTab === 'heatmap' && (
              <>
                ...
                <h3 className="text-xl font-bold text-white mb-2 tracking-tight">Expression Heatmap</h3>
                <p className="text-white/40 max-w-sm font-medium leading-relaxed">
            ...
            {activeTab === 'de' && (
              <>
                ...
                <h3 className="text-xl font-bold text-white mb-2 tracking-tight">Differential Expression</h3>
                <p className="text-white/40 max-w-sm font-medium leading-relaxed">
